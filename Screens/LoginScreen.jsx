...
import { StyleSheet, Text, View, ImageBackground, TextInput, Button, TouchableOpacity, Platform, KeyboardAvoidingView, Keyboard, TouchableWithoutFeedback, Image } from "react-native";
            ...
            <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : ''}>
                ...
                >
                        ...
                        <Text style={{ ...styles.haveAccount, display: showInFocus ? "none" : "block" }}>
                            <Text>Ще не зареєструвались? Зареєструйтесь</Text>
                        </Text>
            </View>
